...
{{--            @endif--}}
{{--            {!! Form::select('fiscal_year_id', $fiscal_years , $current_fiscal_year_id, array('id'=>'fiscal_year_id', 'class'=> 'adjust-width selectize-use','placeholder'=>'Select a Year') ) !!}--}}
...
{{--        <tr>--}}
{{--            <td width="80%"><b>Staff ID: </b>{{$staff->main_id}}</td>--}}
{{--        <tr>--}}
{{--        <tr>--}}
{{--            <td width="80%"><b>Staff Name: </b>{{$staff->name_eng}}</td>--}}
{{--            <td><b>Branch:</b> {{$staff->branch->office_name}}</td>--}}
{{--        </tr>--}}
{{--        <tr>--}}
{{--            <td width="80%"><b>Work Hour: </b>{{$staff->workschedule->last()->work_hour ?? ''}}</td>--}}

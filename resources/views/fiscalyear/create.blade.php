@extends('layouts.default', ['crumbroute' => 'fiscalyearcreate'])
@section('title', $title)
@section('content')

    {{ Form::open(array('route' => 'fiscal-year-save'))  }}

    <div class="row">
        <div class="col-md-7 col-sm-12">
            {{-- Basic Info --}}
            <div class="basic-info card">
                <h5 class="card-header">Fiscal Year Information</h5>
                ...
                <div class="card-block">
                    <div class="card-text">
                        <div class="form-group row">
                            ...
                            {{ Form::text('fiscal_start_date_np', null, array('class' => 'form-control nep-date','id'=>'nep-date1' , 'placeholder' => 'Please enter starting Date',
                             'required' => 'required'))  }}
                            <input type="hidden" id="fiscal_start_date" name="fiscal_start_date" >
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::text('fiscal_end_date_np', null, array('class' => 'form-control nep-date','id'=>'nep-date2' , 'placeholder' => 'Please enter end Date',
                             'required' => 'required'))  }}
                            <input type="hidden" id="fiscal_end_date" name="fiscal_end_date" >
                        </div>
                        <div class="form-group row">
                            <label for="fiscal_code" class="col-3 col-form-label">
                                Code
                            </label>
                            {{ Form::text('fiscal_code', null, array('class' => 'form-control', 'id' => 'fiscal_code', 'placeholder' => 'Please Enter Fiscal Code',
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::number('present_days', null, array('class' => 'form-control', 'id' => 'present_days', 'placeholder' => 'Please Enter Present Days',
                             'data-validation' => 'required',
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::select('fiscal_status', $status_options, null, array('placeholder' => 'Select One...', 'required' => 'required'))  }}
                        </div>
                    </div>
                </div>
            </div>

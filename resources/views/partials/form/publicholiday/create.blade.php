            ...
            <div class="card-block">
                <div class="card-text">
                    <div class="form-group row">
                        ...
                        {{ Form::select('fy_year', $fiscalyear, $selectedFiscalYear ?? null, ['class' => 'form-control', 'placeholder' => 'Select One...', 'required'])  }}
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                @foreach($branches as $key => $branchName)
                                    <div class="col-md-4">
                                        <div class="row">
                                            {{ Form::checkbox('branch_id[]', $key, ['multiple', 'id' => 'branch_id',  'class' => 'branch col-md-1', 'placeholder' => 'Select a branch'])  }}
                                            {!! Form::label($branchName,  $branchName, ['class' => 'col-md-11']) !!}
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        {{ Form::textarea('holiday_descri', null, ['class' => 'form-control', 'placeholder' => 'Public Holiday Description'])  }}
                    </div>
                    ...
                    <div class="radio-inline">
                        @foreach($genders as $value => $gender)
                            <label class="custom-control custom-radio radio-inline-label">
                                <input id="radio{{$value}}" name="gender_id" type="radio" class="custom-control-input"
                                       value="{{$value}}" {{isset($publicHoliday) ? $publicHoliday->gender_id == $value ? 'checked' : '' : ''}}>
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                @foreach($castes as $key => $casteName)
                                    <div class="col-md-4">
                                        <div class="row">
                                            {{ Form::checkbox('caste_id[]', $key, in_array($key, $publicHoliday->getRelatedCastesIds()->toArray()), ['multiple', 'id' => 'caste_id',  'class' => 'caste col-md-1', 'placeholder' => 'Select a caste'])  }}
                                            {!! Form::label($casteName,  $casteName, ['class' => 'col-md-11']) !!}
                                        </div>
                                    </div>
                                @endforeach
                            </div>

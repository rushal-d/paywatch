@extends('layouts.default', ['crumbroute' => 'localattendance-index'])
@section('title', $title)
    ...
    <div class="row">
        <div class="col-md-5 col-sm-12">
            ...
            <div class="basic-info card">
                <h5 class="card-header">Filter Local Attendance Summary</h5>
                    ...
                    <div class="card-text">
                        @if(!auth()->user()->hasRole('Employee'))
                            <div class="form-group row">
                                ...
                                {!! Form::select('branch_id', $branches , null,array('id'=>'branch_id','required'=>'required','data-validation' => 'required',
                        ...
                        <div class="form-group row">
                            ...
                            {!! Form::select('staff_type[]', $staff_types , $_GET['staff_type']?? null, array('id'=>'staff_type ','placeholder'=>'Select Staff Type', 'class' => 'staff_type','multiple') ) !!}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {!! Form::select('fiscal_year_id', $fiscal_years , $current_fiscal_year_id, array('id'=>'fiscal_year_id ','placeholder'=>'Select a Year', 'class' => 'fiscal_year_id') ) !!}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {!! Form::select('month_id', $months , $currentNepaliDateMonth, array( 'id'=>'month_id', 'placeholder'=>'Select a Month') ) !!}
                        </div>

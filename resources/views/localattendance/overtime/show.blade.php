...
<div class="print-buttons">
    <a href="{{route('overtime-work-index')}}" class="button">Go Back</a>
    <a href="{{route('overtime-work-excel-export',$_GET)}}" class="button">Excel Export</a>
    <button class="button button-print" onclick="printDiv('printableArea')">Print</button>
    @if($previous_staff_id > 0)
        <a href="{{route('overtime-work-show', [
...
<div id="printableArea">
    @include('localattendance.overtime.overtime-table')
</div>

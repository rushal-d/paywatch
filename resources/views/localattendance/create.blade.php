@extends('layouts.default', ['crumbroute' => 'force-entry-attendance-create'])
@section('title', $title)
@section('style')
    <style>
    ...
    <div class="row main-content">
        ...
        <div class="col-md-7 col-sm-12">
            ...
            <div class="basic-info card">
                <h5 class="card-header">Manage Force Entry Attendance</h5>
                <div class="card-block">
                    <div class="card-text">
                        <div class="form-group row">
                            ...
                            {!! Form::select('branch_id', $branches , $branch_id ?: null,array('id'=>'branch_id','required'=>'required','data-validation' => 'required',
                        ...
                        <div class="form-group row">
                            <label for="attendance_date_np" class="col-3 col-form-label">
                                Attendance Date NP<span class="required-field">*</span>
                            </label>
                            {{ Form::text('attendance_date_np', $attendance_date_np ?? null, ['class' => 'form-control nep-date','required' => 'true' ,'id'=>'attendance_date_np' , 'placeholder' => 'Enter Date:', 'readonly' => 'readonly']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('punchin_datetime_np', null, ['class' => 'form-control','required' => 'true','id'=>'punchin_datetime_np' , 'placeholder' => 'Enter Punch In Time:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('tiffinout_datetime_np', null, ['class' => 'form-control', 'id'=>'tiffinout_datetime_np' , 'placeholder' => 'Enter Tiffin OutTime:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('tiffinin_datetime_np', null, ['class' => 'form-control', 'id'=>'tiffinin_datetime_np' , 'placeholder' => 'Enter Tiffin In Time:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('personalout_datetime_np', null, ['class' => 'form-control', 'id'=>'personalout_datetime_np' , 'placeholder' => 'Enter Personal Out Time:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('personalin_datetime_np', null, ['class' => 'form-control', 'id'=>'personalin_datetime_np' , 'placeholder' => 'Enter Personal In Time:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('lunchout_datetime_np', null, ['class' => 'form-control', 'id'=>'lunchout_datetime_np' , 'placeholder' => 'Enter Lunch Out Time:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('lunchin_datetime_np', null, ['class' => 'form-control', 'id'=>'lunchin_datetime_np' , 'placeholder' => 'Enter Lunch In Time:']) }}
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            {{ Form::time('punchout_datetime_np', null, ['class' => 'form-control', 'id'=>'punchout_datetime_np' , 'placeholder' => 'Enter Punch Out Time:']) }}
                        </div>
        ...
        function onChangeBranchId() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#staff').next().next().addClass('removeit');

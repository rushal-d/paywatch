...
<div class="print-buttons">
    <a href="{{route('all-staff-attendance-monthly')}}" class="button">Go Back</a>
    @php
        $_GET['excel']=1;
    @endphp
    <a href="{{route('all-staff-attendance-monthly-show',$_GET)}}" class="button">Excel Export</a>
</div>
...
<div class="">
    <div class="search-box">
        ...
        {{ Form::open(array('route' => 'all-staff-attendance-monthly-show','method'=>'GET'))  }}
...
<div id="printableArea">
    ...
    @include('localattendance.allstaff.table')
</div>

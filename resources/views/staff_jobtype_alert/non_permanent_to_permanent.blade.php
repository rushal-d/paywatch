@extends('layouts.default', ['crumbroute' => 'staff-jobtype-alert-warning-non-permanent-to-permanent'])
@section('title', $title)
@section('style')
...
@section('content')
    <div class="card">
        ...
        {{ Form::open(array('route' => 'staff-job-type-alert.non-permanent-to-permanent','method' => 'get', 'id' => 'staff-get-promotion-alert'))  }}
        <div class="card">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <span class="text-danger">[Minimum Work Days Limit: {{config('constants.staff_permanent_promotion.minimum_work_days')}} days]</span>
                    ...
                    <tr style="color: red">
                        ...
                        <td>
                            ...
                            <button type="button"
                                    ...
                                    data-temporary-date="{{$staffmain->temporary_con_date_np}}"
                            >
                                Change to Permanent
                            </button>
                        </td>
            ...
            <div class="modal fade" id="singleStaffModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(['method' => 'post', 'route' => 'staff-job-type-alert.change-non-permanent-to-permanent','id' => 'modal-single-form']) !!}
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::label('permanent_date_modal', 'Permanent Date:',  ['class' => 'control-label']) !!}
                                {!! Form::text('permanent_date_modal', '', ['class' => 'form-control nep-date custom-modal col-md-5', 'readonly' => 'readonly', 'data-validation' => 'required',]) !!}
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $('#modal-single-form').submit(function (e) {
            var $_this = $(this);
            var $_permanent_date_input = $('#permanent_date_modal');
            var $_staff_central_id_input = $('#staff_central_id_modal');

            if ($_permanent_date_input.val() !== '') {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    data: {
                        _token: '{{ csrf_token() }}',
                        permanent_date: $_permanent_date_input.val(),

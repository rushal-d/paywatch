@extends('layouts.default', ['crumbroute' => 'pfledger-personal'])
@section('title', $title)
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <form action="{{ route('pfledger-personal') }}" method="get">
            ...
            <form action="{{ route('pfledger-personal') }}" method="get" id="reset-form">
                <input type="hidden" name="staff_central_id" value="{{$staff->id}}">
        ...
        <div class="card-block">
            ...
            <div id="printableArea">
                ...
                <table width="80%" cellspacing="0" align="center" border="1px">
                    <thead>

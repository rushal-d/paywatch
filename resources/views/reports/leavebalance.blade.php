...
@section('content')
    ...
    {{ Form::open(array('route' => 'leavebalancestatementshow','method'=>'GET'))  }}
    <div class="row">
        <div class="col-md-7 col-sm-12">
            {{-- Basic Info --}}
            <div class="basic-info card">
                <h5 class="card-header">Leave Balance Summary</h5>
                <div class="card-block">
                    <div class="card-text">
                        ...
                        <div class="form-group row">
                            <label for="leave_type" class="col-3 col-form-label">Leave Type</label>
                            {{Form::select('leave_type', $leaves, null, ['class' => 'form-control', 'data-validation' => 'required', 'id' => 'leave_type', 'placeholder' => 'Leave Type'])}}
                        </div>

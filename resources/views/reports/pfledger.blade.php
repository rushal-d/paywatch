@extends('layouts.default', ['crumbroute' => 'pfledger'])
@section('title', $title)
@section('content')


    <form action="{{ route('pfledger-personal') }}" method="get" enctype="multipart/form-data">
    ...
    <div class="card">
        <div class="quick-actions">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <span class="nav-link"> <i class="fa fa-align-justify"></i> Providend Fund Statement</span>
                </li>
        ...
        <div class="search-box">
            {{ Form::open(array('route' => 'pfledger', 'method'=> 'GET' ,'class' => 'search-form')) }}
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                    ...
                    <a class="btn btn-outline-success btn-reset" href="{{ route('pfledger')}}"><i
    ...
    <div class="card">
       {{-- <div class="card-header">
            ...
            <span>{{ $title }}</span>
            <form action="{{ route('pfledger') }}" method="get">
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="card-block">
            ...
            <div class="row" id="printableArea">
                <div class="text-center col-md-12">
                    <h5>Providend Fund Statement</h5>
                </div>
                ...
                @endif
                <table border="1px" width="80%" cellspacing="0" align="center" class="text-center">
                    <thead>
                    ...
                    <th>S.No.</th>
                    <th>Month</th>
                    <th>No. of Staff Paid</th>
                    <th>Profund [Employee's Contribution]</th>
                    <th>Profund [Company's Contribution]</th>
                    <th>Amount</th>
                    <th>Total</th>
                    </thead>
                    @foreach($months as $month)
                        <tr>
                            ...
                            <td>{{$details['employee_contri'][$month] ?? '-'}}</td>
                            <td>{{$details['company_contri'][$month] ?? '-'}}</td>

@extends('layouts.default', ['crumbroute' => 'taxstatement-personal'])
@section('title', $title)
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <span>{{ $title }}</span>
            <form action="{{ route('taxstatement-personal') }}" method="get">
                <div class="row">
                    <div class="col-md-4">
            ...
            <form action="{{ route('taxstatement-personal') }}" method="get" id="reset-form">
                <input type="hidden" name="staff_central_id" value="{{$staff->id}}">

...
@section('content')
    ...
    {{ Form::open(array('route' => 'bonuses.store'))  }}
                ...
                <div class="card-block">
                    <div class="card-text">
                        ...
                        <div class="form-group row">
                            ...
                            {!! Form::select('fiscal_year_id', $fiscal_year, null, ['class' => 'input-sm', 'id' => 'fiscal_year', 'required' => 'required', 'placeholder' => 'Fiscal Year']) !!}
                        </div>
{{--                        <div class="form-group row">--}}
{{--                            {!! Form::label('branch_id', 'Branch ', ['class' => 'col-3 col-form-label']) !!}--}}
{{--                            {!! Form::select('branch_id', $branch, null, ['class' => 'input-sm', 'id' => 'fiscal_year', 'required' => 'required', 'placeholder' => 'Branch']) !!}--}}
{{--                        </div>--}}
                        <div class="form-group row">
                            {!! Form::label('received_date', 'Received Date ', ['class' => 'col-3 col-form-label']) !!}
                            {!! Form::text('received_date', null, ['class' => 'input-sm col-8.5 form-control', 'id' => 'received_date', 'required' => 'required', 'placeholder' => 'Date', 'readonly' => 'readonly']) !!}
                        </div>
                        <div class="form-group row">
                            {!! Form::label('received_date_np', 'Received Date (NP) ', ['class' => 'col-3 col-form-label']) !!}
                            {!! Form::text('received_date_np', null, ['class' => 'input-sm col-8.5 form-control', 'id' => 'received_date_np', 'required' => 'required', 'placeholder' => 'Date', 'readonly' => 'readonly']) !!}
                        </div>
                        <div class="form-group row">
                            {!! Form::label('received_amount', 'Received Amount ', ['class' => 'col-3 col-form-label']) !!}
                            {!! Form::number('received_amount', null, ['class' => 'input-sm col-8.5 form-control', 'id' => 'received_amount', 'required' => 'required', 'placeholder' => 'Amount']) !!}
                        </div>
                    </div>
                </div>

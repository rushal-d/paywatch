@extends('layouts.default', ['crumbroute' => 'section'])
@section('title', $title)
...
@section('content')
    ...
    <div class="card">
        <div class="quick-actions">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('sectioncreate') }}"><i class="fa fa-plus"></i> Add
                        New</a>
                </li>
                <li class="nav-item">
        ...
        <div class="search-box">
            {{ Form::open(array('route' => 'section', 'method'=> 'GET' ,'class' => 'search-form')) }}
            <div class="row">
    ...
    <div class="card">
        <div class="card-header">
            <i class="fa fa-align-justify"></i> All Section
            <span class="tag tag-pill tag-success pull-right">{{ $sections->total() }}</span>
        </div>
        <div class="card-block">
            <table class="table table-responsive table-striped table-hover table-all" width="100%" cellspacing="0">
                ...
                @foreach($sections as $section)
                    <tr>
                        <td><input type="checkbox" class="check-id" data-id="{{ $section->id }}"></td>
                        <td>
                            <a href="{{ route('sectionedit',['id' => $section->id]) }}">{{ $section->section_name  }}</a>
                        </td>

                        <td class="actions-col">
                            <div class="actions">
                                <a class="btn btn-sm btn-outline-danger delete-btn" data-id="{{ $section->id }}"
            ...
            <div class="pagination-links">{{ $sections->appends($_GET)->links()
	  		}}
            </div>
        </div>
    </div>

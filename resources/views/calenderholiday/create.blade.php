@extends('layouts.default', ['crumbroute' => 'calenderholidaycreate'])
@section('title', $title)
@section('style')
...
@section('content')
    ...
    {{ Form::open(array('route' => 'calender-holiday-save','id'=>'grant-leave-form'))  }}

    <div class="row">
        <div class="col-md-7 col-sm-12">
            {{-- Basic Info --}}
            <div class="basic-info card">
                <h5 class="card-header">Approved Leave Information</h5>
                    ...
                    <div class="card-text">
                        <div class="form-group row">
                            ...
                            <input type="text" id="staff_central_id" name="staff_central_id"
                                   value="{{old('staff_central_id')}}" class="input-sm" required>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-right form-control">
                            {{ Form::submit('Save',array('id' => 'submit-form', 'class'=>'btn btn-success btn-lg','type'=>'button'))}}
                        </div>
                    </div>
                </div>
            </div>

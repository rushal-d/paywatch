                ...
                <tr>
                    <td align="center">
                        <table border="0" cellpadding="0" cellspacing="0" width="570">
                            ...
                            <tr>
                                <td width="70">
                                    <a href="{{env('APP_URL')}}" target="_blank"><img alt="BMP Paywatch" height="47.0"
                                                                                      src="{{asset('assets/images/logo.png')}}"
                                                                                      style="border:0" width="50.0"></a>
                                </td>
                                <td style="font-family:'Open Sans',arial,sans-serif!important;font-size:25px;line-height:30px!important;font-weight:200!important;color:#252b33!important">
                                    BMP Paywatch
                                </td>
                            </tr>
                            </tbody>
                                    ...
                                    <table width="85%">
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                Branch: {{$branch_name ?? ''}}<br> Last Sync Time: {{$last_sync_time}}
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="78%">
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                This is automatically generated email inorder to notify you that local
                                                paywatch application is unable to sync the data to the server.
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>

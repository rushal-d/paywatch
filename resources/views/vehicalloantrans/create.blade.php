@extends('layouts.default', ['crumbroute' => 'vehicalloancreate'])
@section('title', $title)
@section('content')

    {{ Form::open(array('route' => 'vehicalloan-save'))  }}
    <div class="row">
                ...
                <div class="card-block">
                    <div class="card-text">
                        ...
                        <div class="form-group row">
                            ...
                            {{--{{ Form::label('title', 'Title') }}--}}
                            {{ Form::text('installment_amount', null, array('class' => 'form-control','id'=>'installment_amount' , 'readonly','placeholder' => 'No of Installment',
                             'data-validation' => 'required',
                             'data-validation-error-msg' => 'Please enter a No of Installment'))  }}
                        </div>
        ...
        $('#staff_central_id').change(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        $('#msg').text('The staff has already taken vehicle loan');

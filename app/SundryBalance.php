...
class SundryBalance extends Model
{
    use SearchableTrait;
    use SoftDeletes;
    protected $table = 'sundry_balances';
    protected $primaryKey = 'id';

    protected $searchable = [
        'columns' => [
            'sundry_balances.staff_central_id' => 10,
            'staff_main_mast.name_eng' => 10
        ],
        /*search by join table ->use table name*/
        'joins' => [
            'staff_main_mast' => ['sundry_balances.staff_central_id', 'staff_main_mast.id'],
        ],
